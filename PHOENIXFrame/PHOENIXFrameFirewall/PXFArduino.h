...
public:
  ...
  void _ScreenInit();
#endif
  void _MP3Init(int pinR, int pinT);
  void _MP3Play();
  void _MP3Stop();
  void _MP3Volume(int volume);
  void _MP3Index(int index);
  void _MP3Next();
  void _IRInit(int pinR);
...
private:
  ...
  float mDist;
  bool mIsNewDist;
  bool mDistCheckMeasureFlag;
  bool mDistCheckLastTime;
