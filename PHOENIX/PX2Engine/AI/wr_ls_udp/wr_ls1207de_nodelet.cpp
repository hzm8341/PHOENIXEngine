...
public:
    virtual void onInit()
    {
        PX2_LOG_INFO("Bringup WrLs1207DE nodelet");
        enabled_ = true;
    ...
    void publishScan()
    {
        ...
        while(ros::ok() && enabled_ == true)
        {
            ...
            {
                PX2_LOG_ERROR("Grab laser data error:ExitFatal");
                return ;
            }
        }
