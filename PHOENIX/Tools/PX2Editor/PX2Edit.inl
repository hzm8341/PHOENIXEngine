...
//----------------------------------------------------------------------------
inline bool Edit::IsEditModeNone() const
{
	return EM_NONE == mEditMode;
}
//----------------------------------------------------------------------------
inline Edit::RenderMode Edit::GetRenderMode() const
{
	return mRenderMode;
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
inline const std::string &Edit::GetSelectedResDir() const
{
...
//----------------------------------------------------------------------------
inline EU_Manager *Edit::GetEU_Manager()
{
	return mEU_Man;
}
//----------------------------------------------------------------------------