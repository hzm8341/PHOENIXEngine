...
{
	mEditObjectTerrain = new0 EditObjectTerrain();
...
//----------------------------------------------------------------------------
EditObjectTerrain *TerrainEdit::GetEditObjectTerrain()
{
	return mEditObjectTerrain;
}
//----------------------------------------------------------------------------
void TerrainEdit::EnableEdit()
{
	...
	if (terrain)
	{
		mBrush->GetRenderable()->Show(true);
		SetTerrain(DynamicCast<RawTerrain>(terrain));
	}
	else
	{
		mBrush->GetRenderable()->Show(false);
	}
}
//----------------------------------------------------------------------------
