...
require("Data/CodeSchoolArduino/scripts/lua/language.lua")
require("Data/CodeSchoolArduino/scripts/lua/language_ansi.lua")
...
function play()
	...
	webView:LoadURL("file:///Data/CodeSchoolArduino/blockly/apps/codeschool/index_local.html")
