...
function ch_SettingFrame()
    ...
    btnRight:SetScriptHandler("ch_SettingCallabck")
	...
	ch_UISetTextFont(textRobotName:GetText(), 32)

    local uiEditBoxName = UIEditBox:New("EditBoxRobotName")
    g_ChaosEditBoxName = uiEditBoxName
	...
	uiEditBoxName:GetBackPicBox():GetUIPicBox():SetTexture("Data/Chaos/images/editorback.png")
	...
	ch_UISetTextFont(textID:GetText(), 32)

    local uiEditBoxID = UIEditBox:New("EditBoxRobotID")
    g_ChaosEditBoxID = uiEditBoxID
	...
	uiEditBoxID:GetBackPicBox():GetUIPicBox():SetTexture("Data/Chaos/images/editorback.png")
...
function ch_SettingCallabck(ptr, callType)
	...
	elseif UICT_RELEASED==callType then
        ...
        if "BtnOK"==name then
			g_Chaos:SetName(g_ChaosEditBoxName:GetText())
			g_Chaos:SetID(g_ChaosEditBoxID:GetText())
		end
