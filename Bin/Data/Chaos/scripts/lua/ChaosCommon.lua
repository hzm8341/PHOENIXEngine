...
function ch_UISetTextFont(text, fontSize)
	text:SetFont("Data/Chaos/fonts/font.ttf", fontSize, fontSize)
end

function chaos_UICreateDlgCommon(frameWidth, frameHeight, titleText)
	...
	picBox:SetTexture("Data/Chaos/images/background.png")
	...
	ch_UISetTextFont(textTitle:GetText(), 48)
	...
	btnClose:GetPicBoxAtState(UIButtonBase.BS_NORMAL):SetTexture("Data/Chaos/images/close.png")	
