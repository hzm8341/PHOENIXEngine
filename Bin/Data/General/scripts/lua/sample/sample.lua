...
function s_SampleCata()
	...
	local model1 = PX2_CREATER:CreateNode_Model("Data/General/models/actors/swk/model.px2obj")
	scene:AttachChild(model1)
	model1.LocalTransform:SetUniformScale(0.05)
	model1.LocalTransform:SetRotateDegree(0.0, 0.0, 180.0)
