...
function rc_FramePadPage()
    ...
    local fText = soundCheck:CreateAddText("Sound")
    fText:GetText():SetFontColor(Float3.WHITE)
    fText:SetAnchorParamVer(-50.0, -50.0)
...
function rc_CreateFrameMode0(parentFrame)
    ...
    btnRoundLeft:GetPicBoxAtState(UIButtonBase.BS_NORMAL):SetTexture("Data/RobotControl/images/directctrl/btn.png")
    ...
    btnRoundRight:GetPicBoxAtState(UIButtonBase.BS_NORMAL):SetTexture("Data/RobotControl/images/directctrl/btn.png")
...
function rc_CreateFrameMode1(parentFrame)
    ...
    btnLeft0:GetPicBoxAtState(UIButtonBase.BS_PRESSED):SetTexture("Data/RobotControl/images/directctrl/btnleftpress.png")
    ...
    btnLeft1:GetPicBoxAtState(UIButtonBase.BS_PRESSED):SetTexture("Data/RobotControl/images/directctrl/btnrightpress.png")
    ...
    btnRight0:GetPicBoxAtState(UIButtonBase.BS_PRESSED):SetTexture("Data/RobotControl/images/directctrl/btnuppress.png")
    ...
    btnRight1:GetPicBoxAtState(UIButtonBase.BS_PRESSED):SetTexture("Data/RobotControl/images/directctrl/btndownpress.png")
