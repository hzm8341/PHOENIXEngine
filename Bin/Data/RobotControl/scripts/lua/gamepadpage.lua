...
function rc_CreateFrameMode0(parentFrame)
    ...
    btnFireLeft:GetPicBoxAtState(UIButtonBase.BS_NORMAL):SetTexture("Data/RobotControl/images/directctrl/btn.png")
    ...
    btnFire:GetPicBoxAtState(UIButtonBase.BS_NORMAL):SetTexture("Data/RobotControl/images/directctrl/btn.png")
