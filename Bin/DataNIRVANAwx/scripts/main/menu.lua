...
function n_CreateMainMenu()
	...
	PX2_APP:Menu_Main_AddItemSeparater("Edit")
	PX2_APP:Menu_Main_AddItem("Edit", "Select", PX2_LM_EDITOR:V("n_Select"), "n_Select", "", "Edit")
	PX2_APP:Menu_Main_AddItem("Edit", "Translate", PX2_LM_EDITOR:V("n_Translate"), "n_Translate", "", "Edit")
	PX2_APP:Menu_Main_AddItem("Edit", "Rotate", PX2_LM_EDITOR:V("n_Rotate"), "n_Rotate", "", "Edit")
	PX2_APP:Menu_Main_AddItem("Edit", "Scale", PX2_LM_EDITOR:V("n_Scale"), "n_Scale", "", "Edit")
	PX2_APP:Menu_Main_AddItemSeparater("Edit")
