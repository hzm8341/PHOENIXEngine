...
function n_AddLanguage()
	...
	PX2_LM_EDITOR:AddItem1("n_Stage", "舞台")
	PX2_LM_EDITOR:AddItem1("n_ResView", "资源")
...
function n_AddLanguage1()
	PX2_LM_EDITOR:AddItem1("n_File", "文件")
	PX2_LM_EDITOR:AddItem1("n_NewFile", "新建文件")
	PX2_LM_EDITOR:AddItem1("n_OpenFile", "打开文件")
	PX2_LM_EDITOR:AddItem1("n_OpenDir", "打开文件夹")
	PX2_LM_EDITOR:AddItem1("n_Exit", "退出")
end