...
//----------------------------------------------------------------------------
void UICurveGroup::OnWidgetPicked(const CanvasInputData &inputData)
{
...
//----------------------------------------------------------------------------
void UICurveGroup::OnSizeNodeNotPicked(const CanvasInputData &inputData)
{
	const APoint &worldPos = inputData.LogicPos;
	Float2 wPos(worldPos.X(), worldPos.Z());
...
//----------------------------------------------------------------------------
void UICurveGroup::OnSizeNodePicked(const CanvasInputData &inputData)
{
	const APoint &worldPos = inputData.LogicPos;
	Float2 wPos(worldPos.X(), worldPos.Z());
