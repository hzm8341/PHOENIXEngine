...
void EU_ProjectItem::SetShowType(ShowType st)
{
	...
	if (addCtrl)
	{
		...
		for (int i = 0; i < numCtrls; i++)
		{
			...
			EU_ProjectItem *item = (EU_ProjectItem*)
	...
	if (addModule)
	{
		...
		for (int i = 0; i < numModules; i++)
		{
			...
			mEU_ProjectTree->AddItem(this, name, name, module);
		}
	}
	...
	if (addNode)
	{
		...
		for (int i = 0; i < numChildren; i++)
		{
			...
			if (child)
			{
				...
				EU_ProjectItem *item = (EU_ProjectItem*)mEU_ProjectTree
					->AddItem(this, name, name, child);
				item->SetShowType(st);
			}
		}
	}
...
//----------------------------------------------------------------------------
void EU_ProjectItem::RemoveAllChildItems()
{
