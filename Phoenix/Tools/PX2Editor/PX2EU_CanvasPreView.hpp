...
namespace PX2
{
	...
	class PX2_EDITOR_ITEM EU_CanvasPreView : public Canvas
	{
		PX2_DECLARE_RTTI;
	...
	protected:
		...
		NodePtr mModelViewRootNode;
		NodePtr mModelNode;
		CameraNodePtr mSceneCameraNode;
	...
	typedef Pointer0<EU_CanvasPreView> EU_CanvasPreViewPtr;
