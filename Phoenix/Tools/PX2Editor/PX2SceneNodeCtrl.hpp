...
namespace PX2
{
	...
	public:
		...
		void OnMotionCalDragType(Camera *camera, APoint posNow, const Sizef &size);
		void OnDraging(Camera *camera, APoint posNow, APoint posBefore, 
			const Sizef &size);
