...
//----------------------------------------------------------------------------
void EU_CanvasStage::OnLeftDown(const APoint &screenPos, const APoint &logicPos)
{
	if (!IsEnable())
		return;
...
//----------------------------------------------------------------------------
void EU_CanvasStage::OnLeftUp(const APoint &screenPos, const APoint &logicPos)
{
	if (!IsEnable())
		return;
...
//----------------------------------------------------------------------------
void EU_CanvasStage::OnLeftDClick(const APoint &screenPos, const APoint &logicPos)
{
	Canvas::OnLeftDClick(screenPos, logicPos);
}
//----------------------------------------------------------------------------
void EU_CanvasStage::OnMiddleDown(const APoint &screenPos, const APoint &logicPos)
{
	Canvas::OnMiddleDown(screenPos, logicPos);
}
//----------------------------------------------------------------------------
void EU_CanvasStage::OnMiddleUp(const APoint &screenPos, const APoint &logicPos)
{
	Canvas::OnMiddleUp(screenPos, logicPos);
}
//----------------------------------------------------------------------------
void EU_CanvasStage::OnMouseWheel(const APoint &screenPos, 
	const APoint &logicPos, float delta)
{
	if (!IsEnable())
		return;
...
//----------------------------------------------------------------------------
void EU_CanvasStage::OnRightDown(const APoint &screenPos, const APoint &logicPos)
{
	if (!IsEnable())
		return;
...
//----------------------------------------------------------------------------
void EU_CanvasStage::OnRightUp(const APoint &screenPos, const APoint &logicPos)
{
	if (!IsEnable())
		return;
...
//----------------------------------------------------------------------------
void EU_CanvasStage::OnMotion(const APoint &screenPos, const APoint &logicPos)
{
	if (!IsEnable())
		return;
