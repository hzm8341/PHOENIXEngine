...
IMPLEMENT_DYNAMIC_CLASS(NA::PropertyGrid, wxWindow)
...
void PropertyGrid::Create ()
{
	...
	mPropGridManager->GetGrid()->SetMarginColour(wxColour(61, 61, 61));
	mPropGridManager->GetGrid()->SetCaptionBackgroundColour(wxColour(61, 61, 61));
...
//-----------------------------------------------------------------------------
void PropertyGrid::OnEvent (PX2::Event *event)
{
	PX2_UNUSED(event);
}
//-----------------------------------------------------------------------------
