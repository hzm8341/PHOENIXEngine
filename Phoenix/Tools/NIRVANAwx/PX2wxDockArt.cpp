...
//----------------------------------------------------------------------------
void PX2wxDockArt::DrawCaption(wxDC& dc, wxWindow *window,
	const wxString& text,
	const wxRect& rect,
	wxAuiPaneInfo& pane)
{
	...
	wxAuiNotebook *noteBook = (wxAuiNotebook*)pane.window;
	int sel = noteBook->GetSelection();
	wxString pageText = noteBook->GetPageText(sel);

	wxString draw_text = wxAuiChopText1(dc, pageText, clip_rect.width);
